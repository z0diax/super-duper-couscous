...
function public_user(array $r): array {
    return ['id'=>$r['id'],'email'=>$r['email'],'name'=>$r['name'],'role'=>$r['role'], 'roleTitle'=>$r['role_title'],'office'=>$r['office'],'division'=>$r['division'], 'position'=>$r['position'],'avatarInitials'=>$r['avatar_initials']];
}
