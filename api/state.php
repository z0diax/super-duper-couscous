...
try {
    ...
    if ($method==='POST') {
        ...
        elseif ($action==='fileLeaveApplication') {
            ...
            fail_unless(($leave['status']??'')!=='Released','Released Leave Applications cannot be edited.',409);
