...
import type { UserAccount, AssigneeDesignation, SystemRoleDefinition, DocumentRecord, ClassificationCategory, WorkflowTemplate, LeaveApplicationRecord, MigrationSummary, AuditEvent, PayrollBatch, PayrollItem, WorkGroup, EmploymentRoutingRule } from '../types';
export interface AppState {
  ...
  leaveApplications: LeaveApplicationRecord[]; migrationSummaries: MigrationSummary[]; auditLogs: AuditEvent[];
  payrollBatches: PayrollBatch[]; payrollItems: PayrollItem[]; workGroups: WorkGroup[]; employmentRoutingRules: EmploymentRoutingRule[];
}
export const emptyState: AppState = { users: [], assigneeDesignations: [], systemRoles: [], documents: [], classifications: [], workflowTemplates: [], leaveApplications: [], migrationSummaries: [], auditLogs: [], payrollBatches: [], payrollItems: [], workGroups: [], employmentRoutingRules: [] };
