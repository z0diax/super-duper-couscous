        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50/60 p-4 shadow-2xs">
          ...
          <div className="space-y-2">
            {heldPayrollItems.map(item => {
              ...
              const usesEmploymentRouting=batch?.workflowStages?.find(stage=>stage.stageNumber===3)?.payrollAssignmentSource!=='workflow';
              const needsProcessor=usesEmploymentRouting&&routingRule?.assignmentMode==='pool';
