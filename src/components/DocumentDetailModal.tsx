          ...
          {tab === 'workflow' && <div className="space-y-5">
            ...
            <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
              ...
              <div className="space-y-2 p-3">{doc.workflowSteps.map(step => {
                ...
                return <div key={step.stepNumber} className={`flex gap-3 rounded-xl border transition-colors ${active ? 'border-blue-400 bg-blue-50/40 p-3 ring-2 ring-blue-100' : completed ? 'border-emerald-100 bg-emerald-50/40 px-3 py-2.5' : 'border-slate-200 bg-white px-3 py-2.5 text-slate-600'}`}>
