          ...
          <div className="relative shrink-0">
            ...
            {isPersonaOpen && (
              <>
                ...
                />
                <div className="absolute right-0 mt-2 w-[min(18rem,calc(100vw-1.5rem))] overflow-hidden rounded-xl border border-slate-200 bg-white text-slate-900 shadow-2xl z-50 animate-in fade-in-50 zoom-in-95 duration-100">
