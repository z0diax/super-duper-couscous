...
function useApplication() {
  ...
  return {
    ...
    fileLeaveApplication: operation('fileLeaveApplication'), updateLeaveApplication: operation('updateLeaveApplication'), deleteLeaveApplication: operation('deleteLeaveApplication'),
