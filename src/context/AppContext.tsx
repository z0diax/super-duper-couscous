...
function useApplication() {
  ...
  return {
    ...
    claimTask: operation('claimTask'), completeStep: operation('completeStep'), returnStep: operation('returnStep'), reassignTask: operation('reassignTask'),
    ...
    updatePayrollItemClassification: operation('updatePayrollItemClassification'), bulkClassifyPayrollItems: operation('bulkClassifyPayrollItems'), markPayrollItemException: operation('markPayrollItemException'), clearPayrollItemException: operation('clearPayrollItemException'), completeInitialCheckingAndRoute: operation('completeInitialCheckingAndRoute'), processWorkGroupItems: operation('processWorkGroupItems'), releasePayrollBatch: operation('releasePayrollBatch'), updateEmploymentRoutingRule: operation('updateEmploymentRoutingRule'),
