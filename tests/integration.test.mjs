...
test('HRMDO leave registry separates applicant and encoder, validates barcodes, and audits registration',async()=>{
  ...
  const data={employeeId:applicant.id,office:'City Engineering Office',barcode:'LEAVE-TEST-0001',leaveType:'Vacation Leave',leaveSubtype:'ABROAD',leaveDetails:'Japan',startDate:'2026-10-01',endDate:'2026-10-02',workingDaysNumber:2,commutation:'Not Requested',remarks:'Official application received'};
