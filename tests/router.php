...
if (in_array($path,['/api/auth.php','/api/state.php','/api/files.php','/api/leave.php','/api/archive.php','/api/settings.php','/api/weather.php'],true)) { require $root.$path; return true; }
