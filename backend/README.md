# HRMDO Laravel backend

This is the incremental Laravel backend for the HRMDO Document Tracking System. It is intentionally deployed beside the existing PHP API while compatibility work is completed.
...
The Laravel app uses its own `.env`; do not commit it or copy production credentials into this directory.
